 ...
 public:
  ...
  class ResidualFn : public mjpc::BaseResidualFn {
   ...
   private:
    ...
    constexpr static double kHeightQuadruped = 0.15;  // meter - adjusted for Bittle
    ...
    constexpr static double kCrouchHeight = 0.10;     // meter - adjusted for Bittle
    ...
    constexpr static double kMaxHeight = 0.5;         // meter - adjusted for Bittle
